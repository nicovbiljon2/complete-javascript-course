...
const switchPlayer = function () {
  document.getElementById(`current--${activePlayer}`).textContent = 0; // set the text content of the active player score back to zero
...
// Challenge - add functionality to the new game button
// My solution
